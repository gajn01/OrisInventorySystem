...
function onDownloadPDFMaterial() {
  ...
  if(table_selected == 1 ){
    table_header = "List of Supplies";
  }else if(table_selected == 2 ){
    table_header = "List of Fixed Assets";
  }else if(table_selected == 3 ){
    table_header = "List of Defective";
  }
  // Select the table
  ...
  var pdfRow = [
    ...
    { text: 'Inventory Date', style: 'header' },
    { text: 'Recieved Date', style: 'header' }
  ];
  pdfData.push(pdfRow);
  var ctr = 0;
  ...
  var docDefinition = {
    content: [
      ...
      {text: table_header, fontSize: 18, bold: true, margin: [0, 20, 20, 8],alignment: 'center'},
      {
        style:'table',
        table: {
          headerRows: 1,
...
function onResetPhysicalFilter() {
  dateStart = '';
  dateEnd ='';
  onViewPhysicalList(table_selected);
}
...
function onDownloadPDFPhysical() {
  let table_header = "List of Supplies";
  if(table_selected == 1 ){
    table_header = "Physical Inventory of Supplies";
  }else if(table_selected == 2 ){
    table_header = "Physical Inventory of Fixed Assets";
  }else if(table_selected == 3 ){
    table_header = "Physical Inventory of Defective";
  }
  // Select the table
